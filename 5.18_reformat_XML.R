...
#load_data
file_dir = "/Users/victoriagao/local_docs/tina_bibliometric/for_hayley_xml/Embase4.xml"
...
write.csv(df_records,"/Users/victoriagao/local_docs/tina_bibliometric/reformatted/Embase4_reformatted.csv", row.names = FALSE)
